...
@endsection
@section('content')
<div class="link-div" btn-add-page-link='/master/w005'></div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 no-padding-right">
            <div class="form-group">
                ...
                <select>
                    ...
                    <option>Danh mục ngữ pháp</option>
                    <option>Danh Mục Từ Vựng</option>
                </select>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12 no-padding-right">
    ...
    <div class="panel-content no-padding-left update-content">
        ...
        <div class="col-sm-3 no-padding-right">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="" class="form-control input-sm required" placeholder="Cập nhật tên danh mục" value="600 từ vựng toleic">
                </div>
            </div>
        </div>
    </div>
