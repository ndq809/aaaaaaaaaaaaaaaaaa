...
@stop
@section('button')
{{Button::menu_button(array('btn-list','btn-add','btn-update-advance-dis','btn-delete-dis','btn-save-dis','btn-cancel-dis','btn-print-dis'))}}
@endsection
@section('content')
            ...
            <table class="table table-hover table-bordered table-update table-focus">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$i}}</td>
                        <td>TV00{{$i}}</td>
                        <td><input type="text" name="" class="form-control input-sm" value="Quy Nguyen"></td>
                        <td><input type="text" name="" class="form-control input-sm" value="Nguyen Quy"></td>
                        <td>
                            <select class="form-control input-sm">
                                <option>Nam</option>
                                <option>Nữ</option>
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <input type="text" name="" class="form-control input-sm" data-field="date" value="this is Datepicker" >
                            </div>
                        </td>
                        <td><input type="text" name="" class="form-control input-sm" value="0123456789"></td>
                        <td><input type="email" name="" class="form-control input-sm" value="quy@gmail.com"></td>
                    </tr>
                    @endfor
                </tbody>
            </table>
    ...
    <div class="panel-content no-padding-left">
        <div class="col-sm-3 no-padding-right">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="" class="form-control input-sm" class="form-control input-sm" value="Quy Nguyen" readonly="">
                </div>
            </div>
        </div>
        <div class="col-sm-3 no-padding-right">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="password" name="" class="form-control input-sm" class="form-control input-sm" placeholder="Nhập mật khẩu mới">
                </div>
            </div>
        </div>
        <div class="col-sm-3 no-padding-right">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="password" name="" class="form-control input-sm" class="form-control input-sm" placeholder="Xác nhận mật khẩu mới">
                </div>
            </div>
        </div>
    </div>
