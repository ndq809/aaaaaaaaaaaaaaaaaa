...
@endsection
@section('content')
<div class="link-div" btn-manager-page-link='/master/w002'></div>
        ...
        <div class="col-sm-3 no-padding-right">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="" class="form-control input-sm required" placeholder="Tên danh mục cần tạo">
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="table table-hover table-bordered table-new-row table-checkbox">
                ...
                <tbody>
                    <tr class="hidden">
                        ...
                        <td><a href="/master/w006" target="_blank"><span class="fa fa-plus" style="padding-bottom: 2px;"></span> Thêm nhóm</a></td>
                    </tr>
                    @for($i=1;$i<=2;$i++)
                    <tr>
                        <td><input type="checkbox" name="" class="sub-checkbox"></td>
