...
@endsection
@section('content')
<div class="link-div" btn-add-page-link='/master/w006'></div>
    ...
    <div class="panel-content no-padding-left update-content">
        ...
        <div class="col-sm-3 no-padding-right">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="" class="form-control input-sm required" class="form-control input-sm" placeholder="Cập nhật tên nhóm" value="Business">
                </div>
            </div>
        </div>
    </div>
