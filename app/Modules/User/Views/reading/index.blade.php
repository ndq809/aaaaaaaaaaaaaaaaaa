	...
	<div class="right-header col-md-12 no-padding">
	 ...
	 <div class="col-md-3 col-md-push-9 right-tab no-padding" >
        ...
        <ul class="nav nav-tabs nav-justified">
            ...
            <li class=""><a class="{{$raw_data[0][0]['btn-forget']==1?'':'btn-disabled'}}" data-toggle="tab" {{$raw_data[0][0]['btn-forget']==1?'href=#tab2':'btn-disabled rank='.$raw_data[0][0]['btn-forget']}} aria-expanded="false" >Những Bài Đã Đọc</a></li>
        </ul>
