	...
	<div class="right-header col-md-12 no-padding">
     ...
     <div class="col-md-6 col-xs-12 right-tab" >
        <div class="form-group">
            ...
            <button class="btn btn-sm btn-default inline-block btn-fix visible-sm visible-xs" id="btn-clear" title="Xóa dữ liệu trên màn hình để nhập bản dịch mới" style="right: 75px" data-target=".en_text" data-toggle="collapse">Đóng</button>
            <div class="default-background en_text in">
     ...
     <div class="col-md-6 col-xs-12 right-tab" >
        <div class="form-group">
            ...
            <button class="btn btn-sm btn-default inline-block btn-fix visible-sm visible-xs" id="btn-clear" title="Xóa dữ liệu trên màn hình để nhập bản dịch mới" data-target=".vi_text" data-toggle="collapse">Đóng</button>
            <div class="default-background vi_text in">
