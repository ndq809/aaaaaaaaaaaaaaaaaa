    ...
    <div class="actionBox" style="padding: 0px;">
        <div class="input-group">
            ...
            <div class="input-group-btn">
                <button class="btn btn-default btn-sm {{$raw_data[0][0]['btn-comment']==1?'btn-comment':'btn-disabled'}}" {{$raw_data[0][0]['btn-comment']==1?'':'rank='.$raw_data[0][0]['btn-comment']}} id="btBinhLuan">Trả lời </button>
            </div>
        </div>
