...
(function e(t, n, r) {
        ...
        SweetModal = (function() {
            ...
            SweetModal.prototype._constructTitle = function($overlay, $modal) {
                ...
                if (typeof this.params.title === 'string') {
                    if (this.params.title !== '') {
                        return $modal.find('.sweet-modal-title').html(this.params.title);
                    } else {
            ...
            SweetModal.prototype._constructContent = function($overlay, $modal) {
                ...
                if (typeof this.params.content === 'string') {
                    $modal.find('.sweet-modal-message').html(this.params.content);
                    ...
                    if (this.params.icon !== '') {
                        ...
                        switch (this.params.icon) {
                            case $.sweetModal.ICON_SUCCESS:
                                this.params.content = templates.icons.success + '<div class="sweet-modal-title">' + this.params.title + '</div>';
                                $modal.find('.sweet-modal-content').css('background', '#B7D968');
                                break;
                            case $.sweetModal.ICON_ERROR:
                                this.params.content = templates.icons.error + '<div class="sweet-modal-title">' + this.params.title + '</div>';
                                $modal.find('.sweet-modal-content').css('background', '#E64A33');
                                break;
                            case $.sweetModal.ICON_WARNING:
                                this.params.content = templates.icons.warning + '<div class="sweet-modal-title">' + this.params.title + '</div>';
                                $modal.find('.sweet-modal-content').css('background', '#F57C00');
                                break;
                            case $.sweetModal.ICON_CONFIRM:
                                this.params.content = templates.icons.confirm + '<div class="sweet-modal-title">' + this.params.title + '</div>';
                                $modal.find('.sweet-modal-content').css('background', '#31B8D2');
                                break;
                        }
                    }
                    ...
                    switch (this.params.icon) {
                        ...
                        case $.sweetModal.ICON_CONFIRM:
                            $icon.delay(240).queue(function() {
                                $icon.addClass('animateConfirmIcon');
                                return $icon.find('.sweet-modal-question-mark').addClass('animateQuestionMark');
                            });
                            break;
                        case $.sweetModal.ICON_ERROR:
                            $icon.delay(240).queue(function() {
    ...
    3: [function(require, module, exports) {
        ...
        (function($) {
            ...
            $.sweetModal.ICON_CONFIRM = 'confirm';
    ...
    4: [function(require, module, exports) {
        module.exports = {
            ...
            modal: "<div class=\"sweet-modal-box\">\n <div class=\"sweet-modal-close\"><a href=\"javascript:void(0);\" class=\"sweet-modal-close-link\ fa fa-window-close-o\"></a></div>\n  \n  <div class=\"sweet-modal-content\">\n<div class=\"sweet-modal-title\"></div>\n  </div>\n \n<div class=\"sweet-modal-message\"></div>\n</div>",
            ...
            icons: {
                ...
                confirm: "<div class=\"sweet-modal-icon sweet-modal-confirm\">\n  <span class=\"sweet-modal-question-mark\"><img src='/web-content/images/icon/question-icon.png' width='80px' height='82px'></span>\n</div>",
            },
