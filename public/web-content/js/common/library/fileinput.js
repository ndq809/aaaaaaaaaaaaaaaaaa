...
(function ($) {
    ...
    defaultPreviewSettings = {
        ...
        audio: {width: "213px", height: "100px"},
    ...
    $.fn.fileinputLocales.vi = {
        ...
        removeLabel: 'Hủy',
        removeTitle: 'Xóa file đã chọn',
        cancelLabel: 'Hủy',
        cancelTitle: 'Bỏ qua upload',
        uploadLabel: 'Tải lên',
        uploadTitle: 'Tải lên file đã chọn',
        msgZoomTitle: 'Xem chi tiết',
        msgZoomModalHeading: 'Xem trước chi tiết',
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) vượt quá kích thước tối đa có thể tải lên là <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'bạn phải chọn ít nhất <b>{n}</b> {files} để có thể tải lên.',
        msgFilesTooMany: 'Số file đã chọn <b>({n})</b> vượt quá giới hạn có thể tải lên <b>{m}</b>.',
        msgFileNotFound: 'File "{name}" không tìm thấy!',
        msgFileSecured: 'Bảo mật của thiết bị không cho phép đọc file "{name}".',
        ...
        msgInvalidFileType: 'File "{name}" có kiểu không đúng . Chỉ có file kiểu "{types}" được cho phép!',
        msgInvalidFileExtension: 'Phần mở rộng của file "{name}" không hợp lệ. Chỉ có "{extensions}" được cho phép',
        msgValidationError: 'Upload lỗi',
        msgLoading: 'Đang tải {index} của {files} &hellip;',
        msgProgress: 'Đang tải {index} của {files} - {name} - {percent}% đã hoàn thành.',
        msgSelected: '{n} {files} đã được chọn',
        msgFoldersNotAllowed: 'Chỉ cho phép kéo thả! {n} duyệt file bị từ chối',
        msgImageWidthSmall: 'Chiều rộng hình ảnh "{name}" ít nhất phải là {size} px.',
        msgImageHeightSmall: 'Chiều cao hình ảnh "{name}" ít nhất phải là {size} px.',
        msgImageWidthLarge: 'Chiều rông hình ảnh "{name}" không được vượt quá {size} px.',
        msgImageHeightLarge: 'Chiều cao hình ảnh "{name}" không được vượt quá {size} px.',
        dropZoneTitle: 'Kéo thả file vào đây &hellip;'
    };

    $.extend($.fn.fileinput.defaults, $.fn.fileinputLocales.en,$.fn.fileinputLocales.vi);
