...
$.DateTimePicker = $.DateTimePicker || {
	...
	defaults:  //Plugin Defaults
	{
		...
		shortDayNames: ["Chủ nhật", "Thứ hai", "Thứ ba", "Thứ tư", "Thứ năm", "Thứ sáu", "Thứ bảy"],
	...
	DateTimePicker.prototype = {
		...
		_modifyPicker: function()
		{
			...
			if(oDTP.settings.showHeader)
			{
				...
				sHeader += "<div class='text-center'>Click vào đối tượng sau đó lăn chuột để chọn nhanh hơn</div>";
				sHeader += "</div>";
			}
			...
			if(oDTP.oData.bDateMode || oDTP.oData.bDateTimeMode)
			{
				...
				else
				{
					if(oDTP.oData.bDateMode && (oDTP.oData.bArrMatchFormat[4] || oDTP.oData.bArrMatchFormat[5] || oDTP.oData.bArrMatchFormat[6] || oDTP.oData.bArrMatchFormat[7]))
					{
						...
						sDate = oFormattedDate.dayShort + ", Ngày " + oFormattedDate.dd+" "+ oFormattedDate.month + ", " + oFormattedDate.yyyy;
				}
			}
			if(oDTP.oData.bTimeMode || oDTP.oData.bDateTimeMode)
			{
				...
				$(oDTP.element).find(".hour .dtpicker-compValue").val(oFormattedTime.hour+" Giờ");
				$(oDTP.element).find(".minutes .dtpicker-compValue").val(oFormattedTime.mm+" Phút");
				$(oDTP.element).find(".seconds .dtpicker-compValue").val(oFormattedTime.ss+" Giây");
