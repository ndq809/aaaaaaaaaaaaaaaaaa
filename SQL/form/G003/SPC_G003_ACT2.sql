IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SPC_G003_ACT2]') AND type IN (N'P', N'PC'))
/****** Object:  StoredProcedure [dbo].[SPC_M001_ACT2]    Script Date: 2017/11/23 15:16:49 ******/
DROP PROCEDURE [dbo].[SPC_G003_ACT2]
GO
/****** Object:  StoredProcedure [dbo].[SPC_M001_ACT2]    Script Date: 2017/11/23 15:16:49 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	,   @w_prs_prg				VARCHAR(10)		= 'G003'
	,   @w_prs_prg_nm			VARCHAR(50)		= 'Danh sách danh mục'
	,   @w_prs_mode				VARCHAR(10)		= 'Delete'
	...
	BEGIN TRY
		SET @w_prs_result = 'OK'
		--
		UPDATE M002 SET M002.del_flg = 1
