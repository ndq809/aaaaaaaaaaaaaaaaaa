...
class Hashids implements HashidsInterface
{
    ...
    {
        $this->salt = Config::get('hashids.salt')!==null?Config::get('hashids.salt'):$salt;
        $this->minHashLength = Config::get('hashids.minHashLength')!==null?Config::get('hashids.minHashLength'):$minHashLength;
        $this->alphabet = Config::get('hashids.alphabet')!==null?implode('', array_unique(str_split(Config::get('hashids.alphabet')))):implode('', array_unique(str_split($alphabet)));
